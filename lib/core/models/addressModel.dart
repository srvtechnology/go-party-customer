class AddressModel {
  ...
  factory AddressModel.fromJson(Map<String, dynamic> json) {
    return AddressModel(
      ...
      createdAt: json['created_at'] != null ? DateTime.tryParse(json['created_at']) ?? DateTime(1970) : DateTime(1970),
      updatedAt: json['updated_at'] != null ? DateTime.tryParse(json['updated_at']) ?? DateTime(1970) : DateTime(1970),
    );
  }
